...
export default class Contents extends Component {
    render() {
        return (
            <Container>
                <Header><H1>Discrete Math</H1></Header>
                <Content padder>
